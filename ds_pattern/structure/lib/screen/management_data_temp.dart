...
class ManagementDataTemp extends StatefulWidget {
  const ManagementDataTemp({super.key});

  @override
  State<ManagementDataTemp> createState() => _ManagementDataTempState();
}

class _ManagementDataTempState extends State<ManagementDataTemp> {
                  ...
                  SizedBox(
                    ...
                    child: Consumer<ManagementDataViewModel>(
                      builder: (context, viewModel, child) => ElevatedButton(
                        onPressed: () {},
                        child: Text('${viewModel.textDay}·${viewModel.textData}·${viewModel.textSpecies}'),
                      ),
                    ),
                  ),
                  SizedBox(
                ...
                child: FutureBuilder<List<String>>(
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.hasData == false) {
                        ...
                        return SingleChildScrollView(child: CustomManagementTable(userSource: snapshot.data!));
                      }
                    }),
              ),
            ),
